...
Sidebar.prototype.init = function()
{
	...
	if(window.location.pathname === '/thesaurus-editor')
		...
		this.addOntologyPalette(true);
	// Removing the default palettes
...
/**
 * Specifies the width of the thumbnails. Default is 42
 */
Sidebar.prototype.thumbWidth = 80;

/**
 * Specifies the height of the thumbnails. Default is 42
 */
...
{
	var elt = document.createElement('a');
	elt.className = 'geItem' + title; // Add the cell name to the class
